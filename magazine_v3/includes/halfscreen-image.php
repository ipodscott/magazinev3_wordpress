			    	...
			    	<?php while(has_sub_field("cover_content")): ?>
						...
						<?php $selectMp4 = get_sub_field('select_video_type'); if ($selectMp4 == "mp4"):?>
							...
							<?php $selectMp4Source = get_sub_field('mp4_source'); if ($selectMp4Source == "url"):?>
	                   		      	<img class="big-play dark-btn movie-btn <?php the_sub_field('select');?>" vidurl="<?php the_sub_field('mp4_remote_source');?>" src="<?php bloginfo('template_directory'); ?>/images/play_dark_btn.svg">
	                   				<img class="big-play lt-btn movie-btn <?php the_sub_field('select');?>" vidurl="<?php the_sub_field('mp4_upload');?>" src="<?php bloginfo('template_directory'); ?>/images/play_lt_btn.svg">
	                   		<?php endif; ?>
						...
						<?php $selectMp4 = get_sub_field('select_video_type'); if ($selectMp4 == "youtube"):?>
							 ...
							 <img class="big-tube movie-btn <?php the_sub_field('select');?>" vidurl="https://www.youtube.com/embed/<?php the_sub_field('youtube');?>?autoplay=1" src="<?php bloginfo('template_directory'); ?>/images/play_lt_btn.svg">
						<?php endif; ?>
